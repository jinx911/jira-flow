...
|-------|-------------|------------------------------|
| Gate 1 | proposal.md + design.md have no placeholders (TBD/TODO), are internally consistent, affected modules are clearly identified. Checkpoint A/B/C have already ensured directional correctness; Gate 1 is the final deliverable quality check | Leader forwards modification feedback to the relevant agent, re-run Gate after changes |
